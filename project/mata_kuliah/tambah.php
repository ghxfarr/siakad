        ...
        <main class="flex-1 p-6 mt-16 md:mt-0">
            <div class="max-w-6xl mx-auto">
                <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
                    ...
                    <p class="text-gray-600 mt-2">Masukkan data mata kuliah baru.</p>
                </div>
                    ...
                    <form method="POST" class="space-y-6">
                        <div>
                            ...
                            <input type="text" id="kode_mk" name="kode_mk"
                                value="<?= htmlspecialchars($_POST['kode_mk'] ?? '') ?>" required
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_mk" name="nama_mk"
                                value="<?= htmlspecialchars($_POST['nama_mk'] ?? '') ?>" required
                                class="mt-1 block w-full rounded-lg border-gray-300 focus:border-primary focus:ring focus:ring-primary/20">
                        </div>
                        <div>
                            ...
                            <input type="number" id="sks" name="sks"
                                value="<?= htmlspecialchars($_POST['sks'] ?? '') ?>" required min="1" max="10"
                                class="mt-1 block w-full rounded-lg border-gray-300 focus:border-primary focus:ring focus:ring-primary/20">
                        </div>
